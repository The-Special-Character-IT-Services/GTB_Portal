    ...
    <div>
      {filteredData.map(todo => (
        <div key={todo.id} className="flex mt-4 items-center">
          ...
          <Button
            btnStyle="mr-3 mb-5 text-green-600 border-green-600 hover:text-white hover:bg-green-900 "
            onClick={() => onCompleteTodo(todo.id)}>
            {todo.isDone ? 'Not Done' : 'Done'}
          </Button>
          <Button
            btnStyle="mr-2 mb-4 text-red-600 border-red-900 hover:text-white hover:bg-red-600 "
